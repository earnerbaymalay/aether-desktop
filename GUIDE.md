...
> [!TIP]
> **Quick links:** For a condensed UI walkthrough, see the [Onboarding Guide](docs/GETTING_STARTED.md). For a daily command reference, see the [Usage Guide](USAGE.md).
